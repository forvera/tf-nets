...
class BatchPreprocessor(object):
    ...
    def __init__(self, dataset_file_path, num_classes, output_size=[227, 227], horizontal_flip=False, shuffle=False,
                mean_color=[255.0, 255.0, 255.0], multi_scale=None):
        ...
        self.images = []
        self.labels = []
        self.images_paths = 'D:/win10/Tensorflow/AI Nets/cnn-finetune/data/VOC2012_classification_dataset/Images/'
...
if __name__=='__main__':
    file_path = 'D:/win10/Tensorflow/AI Nets/cnn-finetune/data/VOC2012_classification_dataset/train_val_txt/train.txt'
    train_processor = BatchPreprocessor(file_path, 20, shuffle=True)
